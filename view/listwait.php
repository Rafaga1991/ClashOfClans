<?php
$dirName = './json/listwait';
$fileName = "$dirName/listwait_" . str_replace('#', '', Session::getClanTag()) . '.json';
...
$listwait = json_decode(file_get_contents($fileName), true);
...
if (isset($_POST['list'])) {
    if (count($_POST['list']) > 0) {
        ...
        file_put_contents($fileName, json_encode($listwait));
    }
...
<div class="container-fluid mt-7">
    <h1 class="text-muted">Lista De Espera Para Guerra</h1>
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    <h2 class="text-muted">Miembros en Espera (<?=count($listwait)?>) <i class="fas fa-hourglass-half"></i></h2>
                </div>
        ...
        <div class="card-body">
            <?php if(count($listwait) == 0):?>
                <div class="text-center">Actualmente no hay miembros en espera.</div>
            <?php endif;?>
            <?php foreach ($listwait as $index => $member) : ?>
                <div class="row">
                    <div class="col">
        ...
        <div class="card-footer">
            <?php if (Session::isPrivilegedInClan()) : ?>
                <a href="#" data-toggle='modal' data-target='#newMemberToListWait' class="btn btn-primary">Nuevo Miembro</a>
                <div class="modal fade" id="newMemberToListWait" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                    <div class="modal-dialog modal- modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="modal-title-default"><img src="<?= $info['badgeUrls']['small'] ?>" alt=""> Agregar a Lista de Espera</h6>
